...
class TrelloFacadeTest {
    ...
    void cardCreation() {
        ...
        TrelloCardDto trelloCardDto = new TrelloCardDto(
                "testName", "test description", "test post", "test id");
        TrelloCard trelloCard = new TrelloCard(
                "testName", "test description", "test post", "test id");

        when(trelloService.createdTrelloCard(trelloCardDto)).thenReturn(new CreatedTrelloCardDto("testId", "testName", "testUrl"));
